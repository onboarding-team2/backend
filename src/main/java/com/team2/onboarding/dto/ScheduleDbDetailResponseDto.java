...
@Getter
@Builder
public class ScheduleDbDetailResponseDto {
    ...
    public static ScheduleDbDetailResponseDto from(ScheduleDb schedule, List<Employee> employees) {
        ...
        return ScheduleDbDetailResponseDto.builder()
                .id(schedule.getId())
